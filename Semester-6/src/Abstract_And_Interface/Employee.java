...
interface BonusEligible {
    void calculateBonus(); // bonus(gunno)
}
...
class FullTimeEmployee extends Employee implements Taxable, BonusEligible {
    ...
    public void calculateTax() {
        ...
        salary -= tax;              
        System.out.println("FullTimeEmployee Tax: " + tax); 
    }
    ...
    public void calculateBonus() {
        bonus = salary * 0.1; 
        System.out.println("FullTimeEmployee Bonus: " + bonus); 
    }
}
...
class PartTimeEmployee extends Employee implements Taxable {
    ...
    public void calculateTax() {
        ...
        salary -= tax;              
        System.out.println("PartTimeEmployee Tax: " + tax); 
    }
}
